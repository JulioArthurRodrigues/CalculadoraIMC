...
Console.Write("Registre seu peso em kg...: ");
...
{
    diagnostico = "Obesidade II (severa, ou seja, está quase indo de Americanas)";
}
else
{
    diagnostico = "Obesidade III (mórbida, nesse caso, você está prestes a ser contratado pelo clube de futebol Vasco da Gama!)";
}
